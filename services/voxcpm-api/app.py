"""VoxCPM2 FastAPI sidecar for OpenMAIC.

OpenMAIC's VoxCPM "Python API" backend posts multipart form data to
``/tts/upload``. This service keeps the Python runtime and model weights out of
the main Next.js container while preserving that protocol.
"""
