 ...
 *
 * This module emits **text only** (HTML/JS/JSON strings); the binary
 ...
 *
 * Pure: depends only on the IR and the effect emitter.
 */
 ...
 * text files (HTML/manifest/README) plus the metadata the packaging
