/**
 * Server-side config + helpers for the isolated MP4 render service.
 *
 * The render service is an optional capability. When it is unconfigured or
 * unhealthy, the app remains available but MP4 export is disabled; the internal
 * transfer ZIP is never offered as a user-facing fallback.
 */
 ...
 * report a truthful enabled/disabled state and disable the MP4 action.
 */
