 ...
 * once at import. Defaults suit the single-container CentOS deployment.
 */
...
export const config = {
  ...
  /** Active (queued+running) jobs allowed per authenticated owner. */
  ...
  maxQueue: intEnv('RENDER_MAX_QUEUE', 5),
